...
export type RedGreenDeficiency = 'protan' | 'deutan'

const PROTAN_MATRICES: readonly Matrix3[] = [
  [
    [1, 0, 0],
    [0, 1, 0],
    [0, 0, 1],
...
const DEUTAN_MATRICES: readonly Matrix3[] = [
  [
    [1, 0, 0],
    [0, 1, 0],
    [0, 0, 1],
...
export const MACHADO_MATRICES: Readonly<
  Record<RedGreenDeficiency, readonly Matrix3[]>
> = {
  protan: PROTAN_MATRICES,
  deutan: DEUTAN_MATRICES,
}
